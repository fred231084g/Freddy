...
class CreateListComments(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            comment = Comments(request_dict['post_id'], request_dict['author_name'], request_dict['author_email'], request_dict['author_url'], request_dict[
                               'created_on'], request_dict['content'], request_dict['karma'], request_dict['approved'], request_dict['agent'], request_dict['type'], request_dict['parent'],)
            comment.add(comment)
